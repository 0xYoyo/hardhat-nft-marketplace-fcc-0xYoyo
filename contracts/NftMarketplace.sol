...
contract NftMarketplace is ReentrancyGuard {
    ...
    //NFT Contract addy -> NFT TokenID -> Listing
     ...
     * @param nftAddress: Address of the NFT's contract
     * @param tokenId: The token ID of the NFT
     * @param price: The listed purchasing price of the NFT
     */
    function listItem(
        address nftAddress,
        uint256 tokenId,
